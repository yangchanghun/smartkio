...
export function KakaoMapView({
  ...
  const handleMessage = (event: WebViewMessageEvent) => {
    try {
      ...
      if (message.type === "center") onCenter?.(message.place);
